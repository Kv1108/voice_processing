#  We have used Agglomerative Hierarchical Clustering (AHC) in this code
...
def process_vad_and_clustering(audio_file):
    ...
    # Applying Agglomerative Hierarchical Clustering (AHC)
    ahc = AgglomerativeClustering(n_clusters=n_clusters, linkage='ward')  
    labels = ahc.fit_predict(mfcc_features_scaled)
